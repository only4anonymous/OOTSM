...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_dir", default="data/charades/ag/videos",
                        help="Folder containing Charades videos.")
    parser.add_argument("--frame_dir", default="data/charades/ag/frames",
                        help="Root folder containing frames to be dumped.")
    parser.add_argument("--annotation_dir", default="data/charades/ag/annotations",

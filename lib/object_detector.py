...
class Detector(nn.Module):
    ...
    def __init__(self, train, object_classes, use_SUPPLY, mode='predcls', device = 'cuda:0'):
    ...
    def _compute_base_features(self, im_data):
        ...
        while counter < im_data.shape[0]:
            ...
            # 打印FINAL_BASE_FEATURES和base_feat所在的device
            # print("##########################")
            # print(FINAL_BASE_FEATURES.device)
            # print(base_feat.device)
            # print("##########################")
